            ...
            <table className="w-full">
              <thead>
                <tr className="bg-dark-800 border-b border-dark-700">
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-100 w-32">
                    Ruimte
                  </th>
                  {DAYS.map((day) => (
                    <th key={day} className="px-3 py-3 text-center text-sm font-semibold text-gray-100">
                          ...
                          <td key={day} className="px-3 py-3">
                            {dayInfo.available ? (
                              ...
                              <div className="flex flex-col items-center gap-1">
                                ...
                                {dayInfo.tenant && (
                                  <span className="text-xs text-gray-500 max-w-[120px] truncate" title={dayInfo.tenant}>
                                    {dayInfo.tenant}
                                  </span>
                                )}
                              </div>
